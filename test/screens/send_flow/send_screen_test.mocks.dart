...
// in provenance_wallet/test/screens/send_flow/send_screen_test.dart.
...
class MockSendBloc extends _i1.Mock implements _i2.SendBloc {
  ...
  @override
  _i3.Future<void> next(String? address, _i2.Asset? denom) =>
      (super.noSuchMethod(Invocation.method(#next, [address, denom]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i3.Future<void>);
}
