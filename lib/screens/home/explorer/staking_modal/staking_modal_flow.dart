...
class StakingModalFlow extends FlowBase {
  const StakingModalFlow(this.accountDetails, {Key? key}) : super(key: key);

  final AccountDetails accountDetails;

  @override
  State<StatefulWidget> createState() => StakingModalFlowState();
}

class StakingModalFlowState extends FlowBaseState<StakingModalFlow>
