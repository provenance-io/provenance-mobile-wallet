...
class TransactionTabState extends State<TransactionTab> {
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (transactionDetails == null) {
                      return StreamBuilder<bool>(
                        initialData: bloc.isLoadingTransactions.valueOrNull,
                        stream: bloc.isLoadingTransactions,
                        builder: (context, snapshot) {
                        ...
                        Expanded(
                          child: Stack(
                            children: [
                              ...
                              StreamBuilder<bool>(
                                initialData: bloc.isLoadingTransactions.value,
                                stream: bloc.isLoadingTransactions,
                                builder: (context, snapshot) {
                                  final isLoading = snapshot.data ?? false;
                                  if (isLoading) {
  ...
  void _onScrollEnd() {
    ...
    if (_scrollController.position.pixels >=
        ...
        !bloc.isLoadingTransactions.value) {
      bloc.loadAdditionalTransactions();
    }
  }
}
