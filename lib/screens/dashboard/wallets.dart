...
class WalletsState extends State<Wallets> with RouteAware, WidgetsBindingObserver {
      ...
      children: [
        ...
        Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: [
                FwText('All Wallets', color: FwColor.globalNeutral550,
                  style: FwTextStyle.sBold,),
              ],
            )
        ),
        ...
        children: [
                  ...
                  onTapDown: (details) {
                    ...
                    onTap: () async {
                      final result = await showMenu(context: context,
                        ...
                        items: [
                          if (!item.isSelected) PopupMenuItem<MenuOperation>(
                      ...
                      if (result == MenuOperation.rename) {
                        final result = await showDialog(
                            ...
                            context: context,
                            builder: (context) =>
                                RenameWalletDialog(currentName: item.accountName));
                        if (result != null) {
                          await ProvWalletFlutter.renameWallet(item.id, result as String);
                          reload.call();
                        }
                      } else if (result == MenuOperation.delete) {
                        final dialogResult = await FwDialog.showConfirmation(context, message: 'Are you sure you want to remove this wallet?', confirmText: 'Yes', cancelText: 'Cancel');
                    ...
                    child: Container(
                      ...
                      color: Colors.white,
                      child: Center(
                          child: FwIcon(FwIcons.menuIcon, color: Theme
                              .of(context)
                              .colorScheme
                              .globalNeutral550)
                      ),
          ...
          Padding(
              ...
              child: Row(
                children: [
                  FwText(
                      '${item.address.substring(0, 5)}...${item.address
                          .substring(30)}',
                      color: FwColor.globalNeutral550,
                      style: FwTextStyle.m
                  ),
