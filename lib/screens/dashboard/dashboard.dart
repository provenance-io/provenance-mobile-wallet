...
class DashboardState extends State<Dashboard> with TickerProviderStateMixin, RouteAware, WidgetsBindingObserver {
  ...
  void initState() {
    ...
    ProvWalletFlutter.instance.onAskToSign =
        (String requestId, String message, String description) async {
        final result =await  FwDialog.showConfirmation(context, title: description, message: message, confirmText: 'Sign', cancelText: 'Decline');
    ...
    ProvWalletFlutter.instance.onAskToSend =
        (String requestId, String message, String description, String cost) {
      final map = jsonDecode(message);


      SendTransactionInfo info = SendTransactionInfo(fee: cost,
          toAddress: map["toAddress"] as String,
          fromAddress: map["fromAddress"] as String,
          requestId: requestId,
          amount: "${(map["amount"] as List)
              .first["amount"]} ${(map["amount"] as List).first["denom"]}");
            ...
            Container(
                ...
                child: TabBar(
                  ...
                  tabs: [
                    ...
                    _buildTabItem(
                        _tabController?.index == 1, 'Transactions',
                        FwIcons.staking),
                  ],
                ))
          ],
                      ...
                      child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              StreamBuilder<WallectConnectStatus>(
                                                ...
                                                initialData: WallectConnectStatus
                                                    .disconnected,
                              ...
                              assets.isNotEmpty ? VerticalSpacer.medium() : Container(),
                              assets.isNotEmpty ? Padding(padding: EdgeInsets.only(left: 20, right: 20), child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [FwText('My Assets', color: FwColor.globalNeutral550, style: FwTextStyle.h6)],)) : Container(),
                              assets.isNotEmpty ? VerticalSpacer.medium() : Container(),
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Container(
                                            width: 32,
                                            height: 32,
                                            child: FwIcon(item.display?.toUpperCase() == 'USD' || item.display?.toUpperCase() == 'USDF' ? FwIcons.dollarIcon : FwIcons.hashLogo, color: Theme.of(context).colorScheme.globalNeutral550, size: 32,),
                                          ),
                                          HorizontalSpacer.medium(),
                                          Column(
                                          ...
                                          FwIcon(FwIcons.caret, color: Theme.of(context).colorScheme.globalNeutral550, size: 12.0,)
                                        ],
                                      ),
                                    ),
                                  )
                                  );
                                return Container(height: 2, color: Theme.of(context).colorScheme.globalNeutral450,);
                              }, separatorBuilder: (context, index) {
                                return VerticalSpacer.small();
                              }, itemCount: assets.length, shrinkWrap: true, physics: NeverScrollableScrollPhysics(),)) : Container(),
                                    ...
                                    return Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            FwButton(child: FwText('Disconnect',
                                              color: FwColor.white,),
                                                onPressed: () {
                                                  ProvWalletFlutter
                                                      .disconnectWallet();
  ...
  Widget _buildTabItem(bool isSelected, String tabName, String tabAsset,
      {isLoading = false}) {
    return Center(
      child: Column(
        children: [
